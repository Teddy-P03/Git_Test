...
void create_record(){
	...
	char breed[20], sex[20], color[20], dis[30];
	float weight;
	...
	fgets(dis,30,stdin);
	dis[strlen(dis)-1] = '\0';
	a_create(breed, sex, color, weight, dis);
}
